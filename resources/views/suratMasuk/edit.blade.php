...
@section('breadcrumb')
  ...
  <li><a href="{{route('operator.surat-masuk.show', $surat->id)}}"><i class="fa fa-users"></i> Detail Surat Masuk</a></li>
	<li class="active">Ubah Surat Masuk</li>
@endsection

@section('create_edit_title') ubah Data Surat Masuk @endsection

@section('create_edit_route') {{route('operator.surat-masuk.update', $surat->id)}} @endsection
...
@section('create_edit_form')
  <div class="row" id="data_utama">
    ...
    <div class="col-md-6">
      ...
      <div class="form-group">
        <label for="tujuan">Tujuan (individu)</label>
    ...
    <div class="col-md-6">
      ...
      <div class="row">
        @foreach($surat->file_surat as $key => $val)
          <div class="col-md-4" id="file{{$key}}">
